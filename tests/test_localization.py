...
def test_runtime_translations_use_requested_language_and_english_fallback() -> None:
    ...
    assert translate("sv", "events.christmas_eve") == "Julafton"
    assert translate("en", "events.christmas_eve") == "Christmas Eve"
    assert translate("de", "events.christmas_eve") == "Christmas Eve"
